function [x, t, U] = conservazione_LF(a, b, N, T, K, c, f, g, u0)
...
%   Metodo numerico: LAX-FRIDRICHS.
% -----------------------------------------------
% Sintassi:
%   [x, t, U] = conservazione_LF(a, b, N, T, K, c, f, g, u0)
%
% Input:
...
for k=1:K
    ...
    U(2:end-1, k+1) = 0.5*(U(1:end-2, k)+U(3:end, k)) + tau*f(x(2:end-1), t(k)) ... 
