function [x, u] = poisson_misto_upwind(L, N, du0dx, uL, f)
...
%
% Metodo numerico: differenze finite con upwind su bordo di Neumann.
% -----------------------------------------------
% Sintassi:
%   [x, u] = poisson_misto_upwind(L, N, du0dx, uL, f)
%
% Input:
...
% Correzione della matrice A (upwind in x = 0)
A(1, 1) = -1;
A(1, 2) = 1;
